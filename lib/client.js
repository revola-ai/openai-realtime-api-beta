  ...
  constructor({ url, apiKey, dangerouslyAllowAPIKeyInBrowser, debug } = {}) {
    ...
    this.defaultSessionConfig = {
      ...
      tools: [
        {
          "type": "function",
          "name": "start_demo_overview_video",
          "description": "Starts playing a demo video for the user.",
          "parameters": {
              "type": "object",
              "properties": {},
              "required": []
        ...
        },
        {
          ...
          "description": "Sets the visual image on the USER's screen to the default image if the context is not sufficient or if transitioning to the Call to Action State.",
          "parameters": {
              "type": "object",
              "properties": {},
              "required": []
        ...
        {
          "type": "function",
          "name": "set_previous_context_image",
          "description": "Sets the visual image on the USER's screen to an image that was previously shown to the user related to the context used to answer the current question.",
          "parameters": {
              "type": "object",
              "properties": {
        ...
        {
          "type": "function",
          "name": "set_bant_scores",
          "description": "Sets the BANT scores for each criterion before ending the meeting.",
          "parameters": {
              "type": "object",
              "properties": {
                "budget": {"type": "string"},
